#ifndef NETLIB_IP4_TCP_SERVER_SOCKET_HPP
#define NETLIB_IP4_TCP_SERVER_SOCKET_HPP


#include "ip4_tcp_client_socket.hpp"
...
namespace netlib::ip4::tcp {
     ...
     * A tcp server socket. 
     */
    class server_socket : public ip4::socket {
    public:
        /**
         ...
         */
        server_socket(client_socket&& src) : ip4::socket(std::move(src)) {
        }
...
#endif //NETLIB_IP4_TCP_SERVER_SOCKET_HPP
