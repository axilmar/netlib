#ifndef NETLIB_IP4_TCP_CLIENT_SOCKET_HPP
#define NETLIB_IP4_TCP_CLIENT_SOCKET_HPP
...
namespace netlib::ip4::tcp {
     ...
     * A tcp client socket. 
     */
    class client_socket : public ip4::socket {
    public:
        /**
         ...
         */
        client_socket(client_socket&& src) : ip4::socket(std::move(src)) {
        }
    ...
    private:
        ...
        client_socket(socket_handle handle) : ip4::socket(handle) {
        }
...
#endif //NETLIB_IP4_TCP_CLIENT_SOCKET_HPP
