#ifndef NETLIB_IP6_UDP_SOCKET_HPP
#define NETLIB_IP6_UDP_SOCKET_HPP
...
namespace netlib::ip6::udp {
     ...
     * A udp socket. 
     */
    class socket : public netlib::ip6::socket {
    public:
        /**
         ...
         */
        socket(socket&& src) : ip6::socket(std::move(src)) {
        }
...
#endif //NETLIB_IP6_UDP_SOCKET_HPP
